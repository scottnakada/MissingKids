    ...
    angular.module('gitTemplate')
        ...
        ['$scope',
            function ($scope) {
                ...
                $scope.web = {
                    link: "http://scottnakada.github.io/MissingKids/yoMissingKids/dist/public/index.html",
                    image: "images/LaptopMissingKids.png"
                };
                $scope.mean = {
                ...
                $scope.android = {
                    ...
                    image: "images/AndroidMissingKids.png"
                };
                $scope.ios = {
                    link: "#ios",
                    image: "images/iPadMissingKids.png",
                    ionicViewId: "f869122b"
                };
                $scope.github = {
                    link: "https://github.com/scottnakada/MissingKids"
                };
